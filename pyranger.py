...
def parse_args():
    ...
    parser.add_argument('--tcrab', dest='atac', type=str, default=None, help='Optional. TCR-AB sample ID.')
    parser.add_argument('--bcr', dest='atac', type=str, default=None, help='Optional. BCR sample ID.')
    parser.add_argument('--tcrgd', dest='atac', type=str, default=None, help='Optional. ATAC sample ID.')
